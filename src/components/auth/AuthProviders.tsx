  ...
  return (
    <div className="flex flex-col gap-4">
      <Button 
        ...
        className="w-full flex items-center justify-center bg-secondary/70 dark:bg-secondary/10 hover:bg-secondary/80 dark:hover:bg-secondary/20 text-foreground"
      >
