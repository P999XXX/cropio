  ...
  return (
    <div className="space-y-2">
      <Button 
        ...
        className="w-full flex items-center justify-center bg-white hover:bg-gray-50 md:bg-[#F1F1F1] md:hover:bg-[#E5E5E5] dark:bg-secondary/10 dark:hover:bg-secondary/20 text-foreground"
      >
