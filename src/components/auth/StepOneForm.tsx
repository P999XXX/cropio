              ...
              <FormControl>
                ...
                >
                  <FormItem>
                    ...
                    >
                      <div className="mb-3 h-20 w-20 rounded-full bg-gray-100 flex items-center justify-center peer-data-[state=checked]:bg-[#F2FCE2] [&:has([data-state=checked])]:bg-[#F2FCE2]">
                        <img 
