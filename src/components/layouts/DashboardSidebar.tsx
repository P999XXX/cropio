...
const DashboardSidebar = () => {
  ...
  return (
    ...
    >
      <SidebarHeader className="flex items-center absolute top-4 left-0 px-2">
        <SidebarTrigger 
              ...
              {mainMenuItems.map((item) => (
                <SidebarMenuItem key={item.label}>
                  <SidebarMenuButton 
                    asChild 
                    tooltip={item.label}
                    className="hover:bg-secondary group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-2"
                  >
