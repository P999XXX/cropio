    ...
    <Header className="h-header px-4 flex items-center">
      <div className="flex justify-between items-center w-full">
        <SidebarTrigger 
          ...
          className={`flex items-center justify-center text-foreground hover:text-black active:text-black hover:bg-transparent active:bg-transparent transition-colors duration-300 ${isExpanded ? 'opacity-0 hidden' : 'opacity-100'}`}
        />
        <div className={`flex items-center justify-between w-full transition-all duration-300 ${!isExpanded ? 'opacity-0 hidden' : 'opacity-100'}`}>
          ...
          <SidebarTrigger 
            icon={PanelLeftClose}
            className="flex items-center justify-center text-foreground hover:text-black active:text-black hover:bg-transparent active:bg-transparent transition-colors duration-300"
          />
        </div>
      </div>
    </Header>
